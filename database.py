...
class DiacriticMapping(db.Model):
    ...
    updated_at = db.Column(db.DateTime, default=lambda: datetime.now(datetime.UTC), 
...
def init_db(app):
    ...
    with app.app_context():
        ...
        required_tables = ['diacritic_mappings', 'feedback']
        tables_exist = all(inspector.has_table(table) for table in required_tables)
